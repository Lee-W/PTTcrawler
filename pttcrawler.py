...
class PTTCrawler:
    ...
    def crawl(self, start=None, end=None, boardName="Gossiping", displayMessage=True):
        ...
        for page in range(start, end+1):
            ...
            for tag in soup.find_all("div", "r-ent"):
                try:
                    ...
                    self.parseContent(link, articleID, displayMessage)
                except:
                    print ("error")
                    pass
            sleep(0.2)
    ...
    def parseContent(self, link, articleID, displayMessage):
        ...
        # message
        messageNum, g, b, n, message, messageN = int(), int(), int(), int(), dict(), dict()
